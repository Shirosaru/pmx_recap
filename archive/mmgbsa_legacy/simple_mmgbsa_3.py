...
if __name__ == "__main__":
    ...
    print(f"[INFO] Detected residue ranges: {chain_residue_ranges}")

    # Use ranges dynamically for Chain_A and Chain_B
    create_chain_index_by_residues(
        tpr_file_path=tpr_for_gmxmmpbsa_cs,
        ndx_file_path=ndx,
        chainA_range=chain_residue_ranges.get('A', (1, 1)),  # fallback to avoid crash
